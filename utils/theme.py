...
def inject_global_css() -> None:
    """ฉีด CSS สำหรับทั้งแอป (พื้นหลังขาวตลอด, KPI 4 กล่องในบรรทัดเดียว)"""
    st.markdown(
        """
<style>
  ...
  /* wrapper: ทำเป็น flex row และให้เลื่อนแนวนอนได้เมื่อจอแคบ */
  .kpi-row{
  ...
  /* กล่อง KPI: ให้มีขนาดเท่ากัน 4 ใบบนเดสก์ท็อปเสมอ (25% ต่อใบ) */
  .kpi-card{
      ...
      min-width:280px;                /* ถ้าจอแคบให้เลื่อน แทนการตัดบรรทัด */
  }
  ...
  /* เนื้อในคาร์ดแบบ compact ให้ทุกใบสูงเท่ากัน */
  ...
  /* ปรับ table/df ให้ขอบบางอ่านง่าย */
  .dataframe tbody tr:hover{ background:#f8fafc; }
    ...
    # สลับคลาส .night ตามสวิตช์ใน Sidebar (st.session_state.display_mode)
